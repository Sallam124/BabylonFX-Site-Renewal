                ...
                item.name === 'Rates' ? (
                  ...
                  <Link
                    ...
                    className={`px-5 py-2.5 rounded-full text-base transition-all duration-300 ${
                      pathname === item.path
                        ? scrolled 
                          ? 'bg-gradient-to-r from-[#FFD700] to-[#B8860B] text-black shadow-[0_0_15px_rgba(255,215,0,0.3)]'
                          : 'bg-white/20 text-white backdrop-blur-sm'
                        : scrolled
                          ? 'text-gray-600 hover:bg-gradient-to-r hover:from-[#FFD700]/60 hover:to-[#B8860B]/60 hover:text-black hover:shadow-[0_0_15px_rgba(255,215,0,0.15)] transition-all duration-300'
                          : 'text-white hover:bg-white/10'
                    }`}
                  >
                    {item.name}
                ...
                {navItems.map((item) => (
                  <Link
                    ...
                    className={`flex items-center px-5 py-4 rounded-xl text-lg transition-all duration-200 ${
                      pathname === item.path
                        ? 'bg-gradient-to-r from-[#FFD700] to-[#B8860B] text-black shadow-[0_0_15px_rgba(255,215,0,0.3)]'
                        : 'text-gray-600 hover:bg-gradient-to-r hover:from-[#FFD700] hover:to-[#B8860B] hover:text-black hover:shadow-[0_0_15px_rgba(255,215,0,0.3)] transition-all duration-300'
                    }`}
                    onClick={() => setIsMenuOpen(false)}
                  >
