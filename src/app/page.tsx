    ...
    <>
      <PageContainer>
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center mt-8 mb-8 px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 bg-gradient-to-r from-gray-800 via-blue-800 to-purple-900 bg-clip-text text-transparent fade-in-up-delay-1 leading-tight pb-2">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className={`bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 fade-in-up${index > 0 ? `-delay-${index}` : ''} border border-white/30`}
                  >
